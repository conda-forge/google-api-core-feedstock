...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-api-core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-api-core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-api-core google-api-core-grpc
# for installing globally
pixi global install google-api-core google-api-core-grpc
```
...
It is possible to list all of the versions of `google-api-core` available on your platform:
...
```
pixi search google-api-core --channel conda-forge
```
